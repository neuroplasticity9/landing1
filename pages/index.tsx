      ...
      <main className="relative h-[548.594vw] w-full select-none overflow-hidden md:h-[182.2vw]">
        <nav className="absolute top-0 z-30 flex w-full md:hidden">
          ...
          <Link href="/" title="App Lục Giới Pong Thần">
            <Image placeholder="empty" src="/images/mobile/logo-app.png" width={104} height={104} className="absolute top-[5%] left-[2%] w-[15.250vw]" alt={'Background landing'} />
          </Link>
        ...
        <Image placeholder="empty" src="/images/bg-landing.jpg" width={1920} height={100} className="hidden h-[100%] w-[100vw] bg-cover md:block" alt={'Background landing'} />
        <Image placeholder="empty" src="/images/mobile/bg-mobile.jpg" width={1920} height={100} className="h-[100%] w-[100%] bg-cover md:hidden" alt={'Background landing'} />
        ...
        <section className="absolute top-0 left-0 h-[100%] w-[100%]">
          ...
          <section className="page page2 relative h-[46.875vw]">
            ...
            <label htmlFor="ngochoang" className="absolute top-[35.5vw] left-[12.5vw] cursor-pointer">
              <Image placeholder="empty" className="h-[7.396vw] w-[7.396vw]" src="/images/tuong-ngoc-hoang-dai-de-check.png" width={142} height={142} alt="Ngọc hoàng đại đế thumbnail" />
            </label>
            <div className="absolute top-[17vw] right-[8vw] hidden animate-headShake peer-checked/ngochoang:block">
              <Image placeholder="empty" className="h-[40.990vw] w-[40.313vw]" src="/images/tuong-ngoc-hoang-dai-de.png" width={774} height={787} alt="Ngọc hoàng đại đế" />
            </div>
            ...
            <label htmlFor="holy" className="absolute top-[35.5vw] left-[21.7vw] cursor-pointer">
              <Image placeholder="empty" className="h-[7.396vw] w-[7.396vw]" src="/images/tuong-cuu-vi-ho-ly-check.png" width={142} height={142} alt="Cửu vĩ hồ ly thumbnail" />
            </label>
            ...
            <label htmlFor="duongtien" className="absolute top-[35.5vw] left-[30.8vw] cursor-pointer">
              <Image placeholder="empty" className="h-[7.396vw] w-[7.396vw]" src="/images/tuong-duong-tien-check.png" width={142} height={142} alt="Duong Tien thumbnail" />
            </label>
            ...
            <div className="absolute top-[17vw] right-[8vw] hidden animate-headShake  peer-checked/thongthien:block">
              <Image placeholder="empty" className="h-[40.990vw] w-[40.313vw]" src="/images/tuong-thong-thien-giao-chu.png" width={774} height={787} alt="Thông Thiên Giáo Chủ" />
            </div>
            ...
            <label htmlFor="tunha" className="absolute top-[44.5vw] left-[30.8vw] cursor-pointer">
              <Image placeholder="empty" className="h-[7.396vw] w-[7.396vw]" src="/images/tuong-khuong-tu-nha-check.png" width={142} height={142} alt="khuong tu nha thumbnail" />
            </label>
            ...
            <label htmlFor="ngokhong" className="absolute top-[44.5vw] left-[40vw] cursor-pointer">
              <Image placeholder="empty" className="h-[7.396vw] w-[7.396vw]" src="/images/tuong-ton-ngo-khong-check.png" width={142} height={142} alt="khuong tu nha thumbnail" />
            </label>
